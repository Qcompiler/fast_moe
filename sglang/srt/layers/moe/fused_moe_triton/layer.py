...
class UnquantizedFusedMoEMethod(FusedMoEMethodBase, CustomOp):
    ...
    def create_weights(
        ...
        **extra_weight_attrs,
        ...
        import os
        self.debug = os.getenv("mydebug", None)
        ...
        if _use_aiter:
            ...
            if self.debug is not None:
                ...
                if x.shape[0] <= 1:
                    ...
                    #         expert_layer_down = layer.w2_weight[expert_idx, :, :].squeeze()
                    #         expert_layer_gate_up = layer.w13_weight[expert_idx, :, :].squeeze()
                    ...
                    down_weight = layer.w2_weight
                    gate_up = layer.w13_weight
                    ...
                    # print(act)
                    # print(act.shape)
                    # print(final_hidden_states_.shape)
