...
parser.add_argument('--jianzhi', type=bool, default=False)
...
class AssemblyParser:
    ...
    def visualize_ast(self, output_file="assembly_ast", dot = None, parent_id = None, input_color = None):
        ...
        node_styles = {
            ...
            "MicroKernel": {"color": input_color, "style": "filled", "shape": "ellipse"},
            "Instruction": {"color": input_color, "style": "filled", "shape": "ellipse"},
            ...
            "Operand": {"color": input_color, "style": "filled", "shape": "ellipse"},
            "RegisterType": {"color": "lightblue", "style": "filled", "shape": "ellipse"},
        }
        
        def add_node(node, parent_id=None, long = None):
            """递归添加节点"""
            node_id = str(id(node))
            ...
            if parent_id:
                if long:
                    dot.edge(parent_id, node_id, minlen='6')
                else:
        ...
        # 添加所有节点
        add_node(self.root.children[1], parent_id, 1)
    ...
    def add_node(parent_id, node, depth=0, later_color_be_defined=False, input_color = None):
        ...
        if isinstance(node, ast.FunctionDef):
            ...
            if cnt == 10:
                ...
                parser.visualize_ast("assembly_ast_detailed", dot, parent_id, input_color)
                return 
...
ast_graph.render('triton_kernel_ast4', format='png', cleanup=True)
print("AST 图形已保存为 triton_kernel_ast4.png")